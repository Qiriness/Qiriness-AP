...
Not built: dashboard authentication, deployed webhook routes, and the agent's tool and drafting stages. 289 tests pass from the repo root (135 of them the `agent/` worker's). Backend/deploy config is still pending.
