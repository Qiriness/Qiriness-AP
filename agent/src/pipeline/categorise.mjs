...
const SYSTEM_PROMPT = [
  ...
  '- 4 : TRÈS RARE. Uniquement dans ces deux cas, et jamais par défaut :',
  "    · menace juridique explicite : action en justice, plainte, avocat, mise en demeure ;",
  '    · atteinte grave à la personne : hospitalisation, ou pronostic vital engagé.',
  ...
  "  Une menace de parler à la presse ou de publier sur les réseaux sociaux n'est PAS un niveau 4 : c'est un client très mécontent, que `happiness` mesure déjà.",
