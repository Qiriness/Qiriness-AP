...
### The monthly report gains 6M vs 6M, and its bridge lies flat (2026-09-23)

- **6M vs 6M changes the figures, not just the chip.** MoM and YoY compare the month; the six-month view replaces every headline with the six months ending in it, against the six before, because a comparison of half-years against a month's value would be nonsense. Both variants are rendered server-side and CSS shows one, as the other comparisons already were. August 2026: €133,966 over six months against €181,983, −26.3%.
